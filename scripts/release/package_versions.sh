...
if [[ $# -ne 6 ]]; then
  fail "expected BUILD_TYPE SOURCE_VERSION DEV_SEQUENCE DEB_ARCH RPM_ARCH LIBC"
fi
...
deb_file="rustfs_${deb_version}_${libc}_${deb_arch}.deb"
rpm_file="rustfs-${libc}-${rpm_version}-${rpm_release}.${rpm_arch}.rpm"
