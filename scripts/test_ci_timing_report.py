...
class TimingTests(unittest.TestCase):
    def setUp(self):
        self.job = {"id": 2, "name": "Workspace Test and Lint", "status": "completed", "conclusion": "success",
                    ...
                    "steps": [{"name": "Test", "status": "completed", "conclusion": "success", "started_at": "2026-09-01T00:16:00Z", "completed_at": "2026-09-01T00:24:00Z"}]}
    ...
    def test_parallel_minutes_are_not_wall_time(self):
        ...
        self.assertEqual(result["jobs"][self.job["name"]]["steps"]["Test"]["median_minutes"], 8)
