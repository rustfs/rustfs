...
|------|------|
| Bucket 创建/删除/列表/头部 | ✅ |
| Object 上传/下载/删除/复制/头部 | ✅ |
| 分段上传（创建/上传/完成/中止） | ✅ |
| ListObjects / ListObjectsV2 | ✅ |
| 预签名 URL（GET/PUT） | ✅ |
| 范围读取（Range GET） | ✅ |
| 条件读取（If-Match/If-None-Match） | ✅ |
| CopyObject（同域/跨域） | ✅ |
| CopyObject 校验和（CRC32/CRC32C/CRC64NVME/SHA1/SHA256/MD5/SHA512/XXHASH3/XXHASH64/XXHASH128） | ✅ |
| 用户元数据（User Metadata） | ✅ |
| Bucket 标签 | ✅ |
| Object 标签 | ✅ |
| Bucket 策略（Policy） | ✅ |
| 公共访问块（Public Access Block） | ✅ |
| CORS 配置 | ✅ |
| S3 Select（SQL 查询） | ✅ |
| Object Lambda | ✅ |
...
| Bucket Policy | ✅ |
| IAM Policy | ✅ |
| 内置策略（consoleAdmin/readwrite/readonly/writeonly） | ✅ |
| 自定义策略 | ✅ |
| 策略条件（Condition） | ✅ |
| Resource 通配符 | ✅ |
| OPA 策略引擎集成 | ✅ |
