...
Source0:        https://github.com/rustfs/rustfs/archive/refs/tags/1.0.0-alpha.2.tar.gz
...
%prep 
%autosetup -n %{name}-%{version}-alpha.2 
...
install %_builddir/%{name}-%{version}-alpha.2/target/%_arch/release/rustfs %buildroot/usr/bin/
