...
- Branch: `overtrue/arch-ecstore-data-movement-layout`
...
- Current phase PR: E-022/E-DATA-MOVEMENT-001 ECStore data movement owner layout.
- Based on: E-021 branch while PR #3930 is pending; rebase onto `origin/main`
  after E-017 through E-021 merge before opening this PR.
- PR type for this branch: `pure-move`.
- Runtime behavior changes: none expected for E-022; production changes are
  module file moves that keep the existing `data_movement` and
  `data_movement_backpressure` module paths.
- Rust code changes: move ECStore data movement and data movement backpressure
  support modules under the `data_movement/` owner directory without
...
- Docs changes: record the API-136 through API-242 owner facade,
  ...
  ECStore root data movement modules after E-022.
