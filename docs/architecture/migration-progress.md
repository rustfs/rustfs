...
- Branch: `overtrue/arch-ecstore-io-support-layout`
...
- Current phase PR: E-025/E-IO-001 ECStore I/O support owner layout.
- Based on: E-024 branch while PR #3930 is pending; rebase onto `origin/main`
  after E-017 through E-024 merge before opening this PR.
- PR type for this branch: `pure-move`.
- Runtime behavior changes: none expected for E-025; production changes are
  module file moves that keep the existing `bitrot`, `compress`, and `rio`
  module paths.
- Rust code changes: move ECStore I/O support modules under the `io_support/`
...
- Docs changes: record the API-136 through API-242 owner facade,
  ...
  I/O support modules after E-025.
