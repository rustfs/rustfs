...
- Branch: `overtrue/arch-ecstore-usage-diagnostics-layout`
...
- Current phase PR: E-023/E-USAGE-DIAGNOSTICS-001 ECStore usage and diagnostics owner layout.
- Based on: E-022 branch while PR #3930 is pending; rebase onto `origin/main`
  after E-017 through E-022 merge before opening this PR.
- PR type for this branch: `pure-move`.
- Runtime behavior changes: none expected for E-023; production changes are
  module file moves that keep the existing `admin_server_info`, `data_usage`,
  and `get_diagnostics` module paths.
- Rust code changes: move ECStore usage and diagnostics/status support modules
  under owner directories without function-body changes.
...
- Docs changes: record the API-136 through API-242 owner facade,
  ...
  root usage and diagnostics modules after E-023.
