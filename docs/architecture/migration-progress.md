...
- Branch: `overtrue/arch-app-storage-error-helper-boundary`
...
- Based on: stacked on API-213 while PR #3856 is pending.
...
1. `consumer-migration`: batch remaining app lifecycle, quota, replication, and metadata owner facade cleanup.
