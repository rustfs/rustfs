...
- Branch: `overtrue/arch-app-bucket-owner-facade-cleanup`
...
- Based on: stacked on API-214 while PR #3856 is pending.
...
1. `consumer-migration`: batch remaining app runtime/global facade cleanup.
