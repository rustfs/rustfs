...
| mode.standalone.existingClaim.dataClaim |sting |"" |Whether to use existing pvc claim for data storage. |
| mode.standalone.existingClaim.logsClaim |sting |"" |Whether to use existing pvc claim for logs storage. |
