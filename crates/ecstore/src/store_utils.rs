...
use rustfs_utils::http::headers::{
    AMZ_OBJECT_TAGGING, AMZ_STORAGE_CLASS, RESERVED_METADATA_PREFIX_LOWER, is_minio_header, is_rustfs_header,
};
...
/// ```
/// use std::collections::HashMap;
/// use rustfs_ecstore::store_utils::extract_user_defined_metadata_keys;
///
...
///
/// let user_keys = extract_user_defined_metadata_keys(&metadata);
...
/// ```
pub fn extract_user_defined_metadata_keys(metadata: &HashMap<String, String>) -> HashMap<String, String> {
...
mod tests {
    ...
    #[test]
    fn test_extract_user_defined_metadata_keys_exclude_system_headers() {
        let mut metadata = HashMap::new();
        metadata.insert("content-type".to_string(), "application/json".to_string());
    ...
    #[test]
    fn test_extract_user_defined_metadata_keys_strip_amz_meta_prefix() {
        let mut metadata = HashMap::new();
    ...
    #[test]
    fn test_extract_user_defined_metadata_keys_exclude_rustfs_internal() {
    ...
    #[test]
    fn test_extract_user_defined_metadata_keys_exclude_minio_headers() {
        let mut metadata = HashMap::new();
    ...
    #[test]
    fn test_extract_user_defined_metadata_keys_mixed() {
        let mut metadata = HashMap::new();
        // System headers
        metadata.insert("content-type".to_string(), "application/json".to_string());
        metadata.insert("cache-control".to_string(), "no-cache".to_string());
    ...
    #[test]
    fn test_extract_user_defined_metadata_keys_empty() {
    ...
    #[test]
    fn test_extract_user_defined_metadata_keys_case_insensitive() {
        let mut metadata = HashMap::new();
        metadata.insert("Content-Type".to_string(), "application/json".to_string());
        metadata.insert("CACHE-CONTROL".to_string(), "no-cache".to_string());
