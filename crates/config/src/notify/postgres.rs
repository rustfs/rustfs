...
pub const ENV_NOTIFY_POSTGRES_HOST: &str = "RUSTFS_NOTIFY_POSTGRES_HOST";
pub const ENV_NOTIFY_POSTGRES_PORT: &str = "RUSTFS_NOTIFY_POSTGRES_PORT";
pub const ENV_NOTIFY_POSTGRES_USER: &str = "RUSTFS_NOTIFY_POSTGRES_USER";
pub const ENV_NOTIFY_POSTGRES_PASSWORD: &str = "RUSTFS_NOTIFY_POSTGRES_PASSWORD";
pub const ENV_NOTIFY_POSTGRES_DATABASE: &str = "RUSTFS_NOTIFY_POSTGRES_DATABASE";
pub const ENV_NOTIFY_POSTGRES_SCHEMA: &str = "RUSTFS_NOTIFY_POSTGRES_SCHEMA";
...
pub const ENV_NOTIFY_POSTGRES_KEYS: &[&str; 15] = &[
    ENV_NOTIFY_POSTGRES_ENABLE,
    ENV_NOTIFY_POSTGRES_HOST,
    ENV_NOTIFY_POSTGRES_PORT,
    ENV_NOTIFY_POSTGRES_USER,
    ENV_NOTIFY_POSTGRES_PASSWORD,
    ENV_NOTIFY_POSTGRES_DATABASE,
    ENV_NOTIFY_POSTGRES_SCHEMA,
