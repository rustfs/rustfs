...
//! Offline log fault-analysis core for RustFS (`rustfs diagnose`).
//!
//! Design contract (see rustfs/backlog#1281):
//! - fully synchronous, no tokio, no rustfs-* internal deps;
//! - order-independent aggregation: analysis never requires globally
//!   time-sorted input;
