...
use rustfs_config::{
    ...
    METER_INTERVAL, SAMPLE_RATIO, SERVICE_VERSION, USE_STDOUT,
};
...
pub struct OtelConfig {
    ...
    pub profiling_endpoint: Option<String>,     // Endpoint for profile collection
    ...
    pub profiling_export_enabled: Option<bool>, // Enable/disable profiling export
