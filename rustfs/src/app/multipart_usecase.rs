        ...
        let (requested_sse, requested_kms_key_id) = if has_ssec {
            ...
            let ssec_write = match ssec_material.key_kind {
                crate::storage::sse::EncryptionKeyKind::Object => {
                    crate::app::storage_compat::rio::WriteEncryption::multipart_object_key(
                        ssec_material.key_bytes,
                        part_id as u32,
                    )
                }
                crate::storage::sse::EncryptionKeyKind::Direct => crate::app::storage_compat::rio::WriteEncryption::multipart(
                    ssec_material.key_bytes,
