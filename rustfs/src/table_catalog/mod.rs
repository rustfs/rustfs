...
const TABLE_RENAME_INTENT_ROOT: &str = "rename-intents";
const TABLE_RENAME_INTENT_MAX_SIZE: usize = 256 * 1024;
const TABLE_RENAME_SECONDARY_OBJECT_MAX_SIZE: usize = 64 * 1024 * 1024;
