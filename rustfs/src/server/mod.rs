...
pub(crate) use prefix::{
    ADMIN_PREFIX, APPLE_TOUCH_ICON_PATH, APPLE_TOUCH_ICON_PRECOMPOSED_PATH, FAVICON_PATH, HEALTH_COMPAT_LIVE_PATH, HEALTH_PREFIX,
    ...
    RPC_PREFIX, RUSTFS_ADMIN_PREFIX, TABLE_CATALOG_COMPAT_PREFIX, TABLE_CATALOG_PREFIX, TONIC_PREFIX, VERSION, console_prefix,
    has_path_prefix, init_console_prefix, is_admin_path, is_table_catalog_path,
};
