...
mod tests {
    ...
    fn test_handler_struct_creation() {
        ...
        let _manual_transition_job_status_handler = ilm_transition::ManualTransitionJobStatusHandler {};
        let _manual_transition_job_cancel_handler = ilm_transition::ManualTransitionJobCancelHandler {};
