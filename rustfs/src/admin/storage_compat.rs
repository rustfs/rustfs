...
pub(crate) type RebalanceStopPropagationRecord = crate::admin::storage_compat::ecstore_rebalance::RebalanceStopPropagationRecord;
...
#[cfg(test)]
pub(crate) type RebalanceCleanupWarningEntry = crate::admin::storage_compat::ecstore_rebalance::RebalanceCleanupWarningEntry;
#[cfg(test)]
...
pub(crate) fn decode_rebalance_stop_propagation_record(message: &str) -> Option<RebalanceStopPropagationRecord> {
    crate::admin::storage_compat::ecstore_rebalance::decode_rebalance_stop_propagation_record(message)
}

#[cfg(test)]
pub(crate) fn encode_rebalance_stop_propagation_record(record: &RebalanceStopPropagationRecord) -> String {
    crate::admin::storage_compat::ecstore_rebalance::encode_rebalance_stop_propagation_record(record)
}
