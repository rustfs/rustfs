...
fn expected_admin_route_matrix() -> Vec<RouteMatrixEntry> {
    vec![
        ...
        admin_route_sample(Method::GET, "/v3/ilm/transition/jobs/{job_id}", "/v3/ilm/transition/jobs/job-123"),
        admin_route_sample(Method::DELETE, "/v3/ilm/transition/jobs/{job_id}", "/v3/ilm/transition/jobs/job-123"),
...
fn test_register_routes_cover_representative_admin_paths() {
    ...
    assert_route(&router, Method::GET, &admin_path("/v3/ilm/transition/jobs/job-123"));
    assert_route(&router, Method::DELETE, &admin_path("/v3/ilm/transition/jobs/job-123"));
