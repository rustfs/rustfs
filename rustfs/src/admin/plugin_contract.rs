...
use rustfs_targets::{TargetDomain, TargetPluginEntrypointKind, TargetPluginPackaging};
use serde::Serialize;
...
mod tests {
    use super::{
        ...
        PluginContractPackaging, PluginInstanceEntry, PluginInstanceSource, PluginInstancesResponse,
    };
    use serde_json::json;
    use std::collections::HashMap;
