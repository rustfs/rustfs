...
impl std::fmt::Debug for Opt {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.debug_struct("Opt")
            ...
            .field("secret_key", &rustfs_utils::mask_sensitive(Some(&self.secret_key))) // Hide sensitive values
            ...
            .field("license", &rustfs_utils::mask_sensitive(self.license.as_ref()))
            ...
            .field("kms_vault_token", &rustfs_utils::mask_sensitive(self.kms_vault_token.as_ref()))
